...
- Usage: Reference from command with `@/Users/aquibvadsaria/project/playground/Mental-Wellness-Tracker/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /Users/aquibvadsaria/project/playground/Mental-Wellness-Tracker/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/aquibvadsaria/project/playground/Mental-Wellness-Tracker/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
