...
```
Agent(
  prompt="Read /Users/aquibvadsaria/project/playground/Mental-Wellness-Tracker/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/aquibvadsaria/project/playground/Mental-Wellness-Tracker/.claude/gsd-core/templates/VALIDATION.md`
